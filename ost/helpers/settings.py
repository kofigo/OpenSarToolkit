...
SINGLE_ARD_OPTIONS = ['CEOS', 'Earth Engine', 'OST Standard', 'OST Flat']
ARD_PRODUCT_TYPES = ['RTC-gamma0', 'GTC-gamma0', 'GTC-sigma0']
...
WINDOW_SIZES = ['5x5', '7x7', '9x9', '11x11', '13x13', '15x15', '17x17']
TARGET_WINDOW_SIZES = ['3x3', '5x5']
...
SINGLE_ARD_PROCESSING_PARAMETERS = {
    ...
    "product_type": ConfigParam(type=str, default='GTC-gamma0', choice=ARD_PRODUCT_TYPES),
    ...
    "speckle_filter": ConfigParamGroup(sub_params={
        ...
        "window_size": ConfigParam(type=str, default="7x7", choice=WINDOW_SIZES),
        "target_window_size": ConfigParam(type=str, default="3x3", choice=TARGET_WINDOW_SIZES),
